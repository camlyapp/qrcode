        ...
        <div className="grid gap-4">
          <Tabs defaultValue="qr" value={generatorType} onValueChange={(v) => handleGeneratorTypeChange(v as GeneratorType)} className="w-full">
            <TabsList className="grid w-full grid-cols-4">
                <TabsTrigger value="qr" className="p-1 h-auto"><QrCode/></TabsTrigger>
                <TabsTrigger value="barcode" className="p-1 h-auto"><Barcode/></TabsTrigger>
                <TabsTrigger value="content" className="p-1 h-auto" disabled={generatorType === 'barcode'}><Text/></TabsTrigger>
                <TabsTrigger value="style" className="p-1 h-auto"><Palette/></TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="style">
                 <ScrollArea className="h-96">
                    <div className="grid gap-4 pr-4 pt-4">
                        <div className="grid gap-2">
                         ...
                         <div className="flex items-center space-x-2">
                            <Switch id="shield-corners" checked={useShieldCorners} onCheckedChange={setUseShieldCorners} disabled={generatorType === 'barcode'} />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                         ...
                         <div className="grid gap-3">
                            <div className="flex items-center space-x-2">
                                <Switch id="gradient-switch" checked={gradientType !== 'none'} onCheckedChange={(checked) => setGradientType(checked ? 'linear' : 'none')} disabled={generatorType === 'barcode'} />
                                <Label htmlFor="gradient-switch" className="cursor-pointer">Use Gradient</Label>
                            </div>
                            {gradientType !== 'none' && generatorType === 'qr' && (
                                <>
                                    <div className="grid gap-2">
                        ...
                        <div className="grid gap-3">
                            <div className="grid gap-2">
                              <Label>Center Image</Label>
                               ...
                               <Button variant="outline" size="sm" onClick={triggerFileSelect} disabled={generatorType === 'barcode'}>
